...
SRC_URI="https://github.com/gramps-project/gramps/tarball/7b4b8b52179ab914f31d1e6f308f69e1400726ac -> gramps-6.0.6-7b4b8b5.tar.gz"
...
post_src_unpack() {
	mv "${WORKDIR}"/gramps-project-gramps-* "${S}" || die
}
